...
<div class="well well-sm" style="background-color: light grey;"><b>Nilai Pokok Ilmu Pengetahuan Sosial Semester I</b></div>
...
<div class="well well-sm" style="background-color: yellow;"><b>Nilai Rata-rata , Nilai Tertinggi dan Nilai Terendah dari Nilai Pokok Ilmu Pengetahuan Sosial Semester I</b></div>
               ...
               header("Location:./index.php");
                ...
                if (isset($_SESSION['username']))
                  {   
                    ...
                    $query  = mysqli_query($konek, "SELECT login.username, AVG(nilai.rata) As nilai_tinggi,MAX(nilai.rata) As nilai_max,MIN(nilai.rata) As nilai_min  FROM nilai, login WHERE nilai.mapel='IPS' AND nilai.smt='1' AND  nilai.kelas = login.username AND login.username = '".$_SESSION['username']."' ")or die(mysqli_error($konek));
...
<div class="well well-sm" style="background-color: light grey;"><b>Nilai Pokok Ilmu Pengetahuan Sosial Semester 2</b></div>
...
<div class="well well-sm" style="background-color: yellow;"><b>Nilai Rata-rata , Nilai Tertinggi dan Nilai Terendah dari Nilai Pokok Ilmu Pengetahuan Sosial Semester II</b></div>
