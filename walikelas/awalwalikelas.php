...
<div class="panel-group">
    <div class="panel panel-info">
      ...
      <div class="panel-body">
         <form action="../config/updatepassword3.php" method="post">
          <?php
...
<div class="panel-group">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pada Menu Nilai Wali kelas dapat melihat nilai Siswa yang diwalikannya dengan cara memilih mata pelajaran kemudian walikelas dapat melihat nilai siswa. <br><br>

<div class="well well-sm">Menu Nilai Quis Online</div>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pada Menu nilai quis online wali kelas dapat melihat nilai latihan soal online yang dikerjakan siswa.<br><br>
