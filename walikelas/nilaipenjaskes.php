...
<div class="panel panel-default">
  <div class="panel-heading" style="background-color: #D2691E;"><b> Nilai PENJASKES Semester I</div>
               ...
               header("Location:./index.php");
                ...
                if (isset($_SESSION['username']))
                  {   
                    ...
                    $query  = mysqli_query($konek, "SELECT login.username, nilai.guru,nilai.kelas,nilai.nis,nilai.smt, nilai.nama,nilai.mapel, nilai.absen, nilai.tugas, nilai.uts, nilai.uas, nilai.rata   FROM  nilai, login WHERE rata like '%".$cari."%' AND nilai.mapel='PENJASKES' AND nilai.smt='1' AND  nilai.kelas = login.username AND login.username = '".$_SESSION['username']."' Order By rata DESC")or die(mysqli_error($konek));
                  }else{

                    $query  = mysqli_query($konek, "SELECT login.username, nilai.guru,nilai.kelas,nilai.nis,nilai.smt, nilai.nama,nilai.mapel, nilai.absen, nilai.tugas, nilai.uts, nilai.uas, nilai.rata   FROM  nilai, login WHERE nilai.mapel='PENJASKES' AND nilai.smt='1' AND  nilai.kelas = login.username AND login.username = '".$_SESSION['username']."' Order By rata DESC")or die(mysqli_error($konek));
...
<div class="well well-sm" style="background-color: #F5DEB3;"><b>Rekap Nilai PENJASKES Semester I</b></div>
               ...
               header("Location:./index.php");
                ...
                if (isset($_SESSION['username']))
                  {   
                    ...
                    $query  = mysqli_query($konek, "SELECT login.username, nilai.nama, AVG(nilai.rata) As nilai_tinggi,MAX(nilai.rata) As nilai_max,MIN(nilai.rata) As nilai_min  FROM nilai, login WHERE nilai.mapel='PENJASKES' AND nilai.smt='1'  AND  nilai.kelas = login.username AND login.username = '".$_SESSION['username']."' ")or die(mysqli_error($konek));
...
<div class="panel panel-default">
  <div class="panel-heading" style="background-color: #1ca0de;"><b><font color="white"> Nilai PENJASKES Semester II</font></b></div>
  <div class="panel-body">
...
<div class="well well-sm" style="background-color: #ADD8E6;"><b>Nilai Pokok PENJASKES Semester II</b></div>
               ...
               header("Location:./index.php");
                ...
                if (isset($_SESSION['username']))
                  {   
                    ...
                    $query  = mysqli_query($konek, "SELECT login.username, nilai.guru,nilai.kelas,nilai.nis,nilai.smt, nilai.nama,nilai.mapel, nilai.absen, nilai.tugas, nilai.uts, nilai.uas, nilai.rata   FROM  nilai, login WHERE rata like '%".$mencari."%' AND nilai.mapel='PENJASKES' AND nilai.smt='2' AND  nilai.kelas = login.username AND login.username = '".$_SESSION['username']."' Order By rata DESC")or die(mysqli_error($konek));
                  }else{
