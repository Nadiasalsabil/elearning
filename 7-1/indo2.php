        ...
        $(document).ready(function(e) {
            ...
            function hitung() {
               ...
               if(jam == 0 && menit == 0 && detik == 0){
            		 ...
            		 window.location.href='jawab1.php';
            	}
...
<div id='timer'></div>
	...
	<h2><center><u>Latihan Bahasa Indonesia 2 </u></center></h2><br>
 ...
 $hasil = mysqli_query($konek, "SELECT * from soal WHERE aktif='Y' AND mapel='Latihan Soal Bahasa Indonesia 2' AND kelas='7-1' ORDER BY RAND()")or die(mysqli_error());
