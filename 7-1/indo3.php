        ...
        $(document).ready(function(e) {
            ...
            function hitung() {
               ...
               if(jam == 0 && menit == 0 && detik == 0){
            		 ...
            		 window.location.href='jawab2.php';
            	}
...
<div id='timer'></div>
 ...
 $hasil = mysqli_query($konek, "SELECT * from soal WHERE aktif='Y' AND mapel='Latihan Soal Bahasa Indonesia 3' AND kelas='7-1' ORDER BY RAND()")or die(mysqli_error());
