...
<body>
  ...
  <img src="images/faces-clipart/pic-1.png">&nbsp;&nbsp;<strong>Edit Jadwal KBM Siswa </strong>&nbsp; SMP Negeri 34 Bekasi 
</div>
...
$edit="SELECT * FROM jadwal WHERE id_jadwal='$_GET[id]'";
$hasil=mysqli_query($konek,$edit)or die(mysqli_error($konek));
$data=mysqli_fetch_array($hasil);
?>

<form  class="forms-sample" action="../config/updatejadwalsiswa.php" method="post">
