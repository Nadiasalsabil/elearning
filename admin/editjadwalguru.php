...
<body>
  ...
  <img class="menu-icon" src="images/menu_icons/06.png" alt="menu icon">&nbsp;<strong>Edit Jadwal Guru</strong> SMP Negeri 34 Bekasi
</div>
...
$edit="SELECT * FROM jadwal_guru WHERE id='$_GET[id]'";
$hasil=mysqli_query($konek,$edit)or die(mysqli_error($konek));
$data=mysqli_fetch_array($hasil);
?>

<form  class="forms-sample" action="../config/updatejadwalguru.php" method="post">
	  <div class="form-group row">
	  	 <input type="hidden" class="form-control" id="id" name="id" value=<?php echo $data['id']; ?>>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Hari</label>
                          <div class="col-sm-9">
                         ...
                         <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Waktu</label>
                          <div class="col-sm-9">
