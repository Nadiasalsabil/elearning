...
<body>
  ...
  <img src="images/faces-clipart/pic-4.png">&nbsp;&nbsp;<strong>Edit Jadwal Tryout</strong>&nbsp; SMP Negeri 34 Bekasi 
</div>
...
$edit="SELECT * FROM jadwal_tryout WHERE id='$_GET[id]'";
$hasil=mysqli_query($konek,$edit)or die(mysqli_error($konek));
$data=mysqli_fetch_array($hasil);
?>

<form  action="../config/updatejadwaltryout.php" method="post">
	  <div class="form-group row">
	  	 <input type="hidden" class="form-control" id="id" name="id" value=<?php echo $data['id']; ?>>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Tryout Ke</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="tryout" name="tryout" value=<?php echo $data['tryoutke'];?>>
                          </div>
                        </div>
