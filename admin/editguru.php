...
<body>
  ...
  <img src="images/faces-clipart/pic-4.png">&nbsp;&nbsp;<strong>Edit Data Guru</strong>&nbsp; SMP Negeri 34 Bekasi 
</div>
...
$edit="SELECT * FROM guru WHERE id_guru='$_GET[id]'";
$hasil=mysqli_query($konek,$edit)or die(mysqli_error($konek));
$data=mysqli_fetch_array($hasil);
?>

<form  class="forms-sample" action="../config/updateguru.php" method="post">
	  <div class="form-group row">
	  	 <input type="hidden" class="form-control" id="id" name="id" value=<?php echo $data['id_guru']; ?>>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="jbt" name="jbt" value="<?php echo $data['jabatan'];?>">
                          </div>
                        </div>
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="jk" name="jk" value=<?php echo $data['jk'];?>>
                          </div>
                        </div>
