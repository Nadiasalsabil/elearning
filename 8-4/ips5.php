        ...
        $(document).ready(function(e) {
            ...
            function hitung() {
               ...
               if(jam == 0 && menit == 0 && detik == 0){
            		 ...
            		 window.location.href='jawab28.php';
            	}
...
<div id='timer'></div>
 ...
 $hasil = mysqli_query($konek, "SELECT * from soal WHERE aktif='Y' AND mapel='Latihan Soal IPS 5' AND kelas='8-4' ORDER BY RAND()")or die(mysqli_error());
