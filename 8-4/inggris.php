    ...
    <thead>
      <tr>
        ...
        <?php
            ...
            $query = mysqli_query($konek, "SELECT id,mapel,judul,bab,tanggal,file FROM materi where id_kelas='8-4' AND mapel='Bahasa Inggris' ")or die(mysqli_error());
    ...
    <thead>
      <tr>
        ...
        <?php
            ...
            $query = mysqli_query($konek, "SELECT id_tq,latihan,id_kelas FROM topik_quis where mapel='Bahasa Inggris' AND id_kelas='8-4' ")or die(mysqli_error($konek));
                    if(mysqli_num_rows($query) == 0){ 
                      echo '<tr><td colspan="5" align="center">Tidak ada data!</td></tr>';  
                    }
                      else
