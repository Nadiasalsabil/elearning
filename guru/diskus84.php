...
<div class="jumbotron" style="background-color: #E6E6FA;">
    ...
    $tampil="SELECT id,nama , upload, diskusi FROM diskusi where id_kelas='8-4'";
   ...
   <form action="../config/diskusi-guru84.php" method="POST" enctype="multipart/form-data">
   <?php
...
?>
    ...
    <input type="text" class="form-control" readonly id="kelas" name="kelas" value="8-4" readonly style="background-color:white;">
  </div>
  <div class="form-group" >
