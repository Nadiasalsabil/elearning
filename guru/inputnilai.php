...
<form name='autoSumForm' action="../config/simpan-nilai.php" method="post">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="abs" name="abs" onFocus="startCalc();" onBlur="stopCalc();">
  </div>
  <div class="form-group">
    <label for="email">Nilai Tugas:</label>
    <input type="text" class="form-control" id="tgs" name="tgs" onFocus="startCalc();" onBlur="stopCalc();">
  </div>
  <div class="form-group">
    <label for="email">Nilai UTS:</label>
    <input type="text" class="form-control" id="uts" name="uts" onFocus="startCalc();" onBlur="stopCalc();">
  </div>
  <div class="form-group">
    <label for="email">Nilai UAS:</label>
    <input type="text" class="form-control" id="uas" name="uas" onFocus="startCalc();" onBlur="stopCalc();">
  </div>
