	<h2><center><u>Latihan Soal Tryout 4 </u></center></h2><br>
 ...
 $hasil = mysqli_query($konek, "SELECT * from soal WHERE aktif='Y' AND mapel='Latihan Soal Tryout 4' AND kelas='9-1' ORDER BY RAND()")or die(mysqli_error());
