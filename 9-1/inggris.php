    ...
    <thead>
      <tr>
        ...
        <?php
            ...
            $query = mysqli_query($konek, "SELECT id,mapel,judul,bab,tanggal,file FROM materi where id_kelas='9-1' AND mapel='Bahasa Inggris' ")or die(mysqli_error());
    ...
    <thead>
      <tr>
        ...
        <?php
            ...
            $query = mysqli_query($konek, "SELECT id_tq,latihan,id_kelas FROM topik_quis where mapel='Bahasa Inggris' AND id_kelas='9-1' ")or die(mysqli_error($konek));
                    if(mysqli_num_rows($query) == 0){ 
                      echo '<tr><td colspan="5" align="center">Tidak ada data!</td></tr>';  
                    }
                      else
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                       ...
                       if($data['latihan'] == 'Latihan Soal Bahasa Inggris 1'){
                        echo '<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris 1"><center>Kerjakan</center></a></td>';
                      }


                       if($data['latihan'] == 'Latihan Soal Bahasa Inggris 2'){
                        echo'<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris 2"><center>Kerjakan</center></a></td>';
                       }


                       if($data['latihan'] == 'Latihan Soal Bahasa Inggris 3'){
                        echo'<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris 3"><center>Kerjakan</center></a></td>';
                       }

                         if($data['latihan'] == 'Latihan Soal Bahasa Inggris 4'){
                        echo'<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris 4"><center>Kerjakan</center></a></td>';
                       }
                         
                      if($data['latihan'] == 'Latihan Soal Bahasa Inggris 5'){
                        echo'<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris 5"><center>Kerjakan</center></a></td>';
                       }


                      if($data['latihan'] == 'Latihan Soal Bahasa Inggris Akhir'){
                        echo'<td><a href="soalindo1.php?halaman=Latihan Soal Bahasa Inggris Akhir"><center>Kerjakan</center></a></td>';
                       }
