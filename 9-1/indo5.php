        ...
        $(document).ready(function(e) {
            ...
            function hitung() {
               ...
               if(jam == 0 && menit == 0 && detik == 0){
            		 ...
            		 window.location.href='jawab4.php';
            	}
...
<div id='timer'></div>
	...
	<h2><center><u>Latihan Bahasa Indonesia 5 </u></center></h2><br>
 ...
 $hasil = mysqli_query($konek, "SELECT * from soal WHERE aktif='Y' AND mapel='Latihan Soal Bahasa Indonesia 5' AND kelas='9-1' ORDER BY RAND()")or die(mysqli_error());
		 ...
		 while($row = mysqli_fetch_array($hasil))
		{
			...
			?>
			<form name="form1" method="post" action="jawab4.php">
