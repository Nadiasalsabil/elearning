	...
	<div class="banner" id="home">
		...
		<header>
			...
			<nav class="navbar navbar-default " >
				...
				<div class="w3-logo">
					<h3><a href="../9-1/9-1.php">E-Learning </h3> <br>
...
if ($halaman=='Latihan Soal Tryout 1')
include 'tryout1.php';

if ($halaman=='Latihan Soal Tryout 2')
include 'tryout2.php';

if ($halaman=='Latihan Soal Tryout 3')
include 'tryout3.php';

if ($halaman=='Latihan Soal Tryout 4')
include 'tryout4.php';

if ($halaman=='Latihan Soal Tryout 5')
include 'tryout5.php';
