...
//error_reporting(0);
 ...
 $input="UPDATE soal SET nip='$nip',kelas='$kelas',mapel='$mapel',soal='$soal',a='$a',b='$b',c='$c', d='$d', e='$e',kunci_jawaban ='kj', gambar='$target_file', tanggal='$tgl', aktif='$aktif' WHERE id_soal='$id'";
    ...
    if ($updaterespon)
        {
            ...
            echo '<META HTTP-EQUIV="REFRESH" CONTENT = "1; URL=../guru/editsoal1.php">';
        }
    else {
